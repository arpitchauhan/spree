...
class AddMissingIndexesOnSpreeTables < ActiveRecord::Migration
  def change
    ...
    unless index_exists?(:spree_products_promotion_rules, [:promotion_rule_id, :product_id])
    ...
    unless index_exists?(:spree_properties_prototypes, [:prototype_id, :property_id])
    ...
    unless index_exists?(:spree_option_types_prototypes, [:prototype_id, :option_type_id])
